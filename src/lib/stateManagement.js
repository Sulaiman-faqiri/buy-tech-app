...
//         }
//         const totalAmount = state.totalAmount + product.price
//         return { cart: updatedCart, totalAmount }
//       } else {
//         const cartItem = { ...product, qty: 1 }
//         const totalAmount = state.totalAmount + cartItem.price
//         return { cart: [...state.cart, cartItem], totalAmount }
//       }
//     }),
...
//           const totalAmount = state.totalAmount - priceReduction
//           return { cart: updatedCart, totalAmount }
//         } else {
